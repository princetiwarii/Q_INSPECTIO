...
const ImageSection = ({ preview, report }) => {
  return (
    <div className="grid grid-cols-2 gap-6 mb-6 max-h-[420px] w-full object-cover bg-red-500">
      {/* Original */}
      <div className=" p-4 rounded shadow max-h-[400px] bg-green-500 object-cover">
