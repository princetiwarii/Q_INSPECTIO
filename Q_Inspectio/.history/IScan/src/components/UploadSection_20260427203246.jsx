  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="bg-white p-4 rounded shadow mb-6 flex gap-4 justify-center">
        <label htmlFor="model-select" className="font-semibold">Select Gemini Model:</label>
        <select
          id="model-select"
          value={selectedModel}
...
const UploadSection = ({ handleUpload, handleReview, selectedModel, setSelectedModel }) => {
  return (
    <div>
      {/* Model Selection */}
      <div className="bg-white p-4 rounded shadow mb-6 flex gap-4 justify-center">
