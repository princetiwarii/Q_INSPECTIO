      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          <button
            ...
            className="px-8 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Analyze Image
          </button>
        </div>
